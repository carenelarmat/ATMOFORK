...
! (requires MOVIE_SURFACE set to .true. in Par_file)
  ...
  real(kind=CUSTOM_REAL),parameter :: CROSS_SECTION_X = 394777.0_CUSTOM_REAL
  real(kind=CUSTOM_REAL),parameter :: CROSS_SECTION_Y = 8326080.0_CUSTOM_REAL
...
!! ATMO CASE FLAT TOPO
 ...
 double precision, parameter :: DEGREES_PER_CELL_TOPO = 2000000.d0
 character(len=*), parameter :: TOPO_FILE = 'DATA/topo_flat.dat'
