...
! a list of UTM zones of the world is available at www.dmap.co.uk/utmworld.htm
  ...
  subroutine geo2utm(rlon4,rlat4,rx4,ry4,UTM_PROJECTION_ZONE)
...
! flag for projection from latitude/longitude to UTM, and back
  integer, parameter :: ILONGLAT2UTM = 0, IUTM2LONGLAT = 1, iway = ILONGLAT2UTM

! input/output parameters
  double precision,intent(out) :: rx4,ry4
  double precision,intent(in):: rlon4,rlat4
  integer, intent(in) :: UTM_PROJECTION_ZONE
