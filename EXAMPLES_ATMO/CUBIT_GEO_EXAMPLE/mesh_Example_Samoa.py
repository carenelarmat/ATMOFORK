...
import geo2utm 
#module is created by f2py -c -m geo2utm geo2utm.f90 
...
x,y=geo2utm.geo2utm(lon,lat,utm_projection_zone)
...
cubit.cmd('volume 1 move x '+str(x)+' y '+str(y))
