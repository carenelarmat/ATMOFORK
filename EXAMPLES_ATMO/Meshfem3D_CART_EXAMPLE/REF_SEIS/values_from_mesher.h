 ...
 !
 ! number of ES nodes =   0.5000000    
 ! percentage of total 640 ES nodes =   7.8125000E-02  %
 ! total memory available on these ES nodes (Gb) =    8.000000    
 !
 ! min vector length =           25
 ! min critical vector length =           75
 !
 ! master process: total points per AB slice =      1015101
 ...
 ! ----------------------------------------------
 !
 ! size of arrays for the largest slice =    176.146854400635       MB
 !                                      =   0.172018412500620       GB
 !
